...
class ProxyPanel(QGroupBox):
    ...
    def _build(self):
        ...
        grid.addWidget(lbl_biid, 9, 0); grid.addWidget(self.inp_biid, 9, 1, 1, 2)
        ...
        while not self._stop.is_set():
            try:
                r = requests.post(
                    poll_url,
                    timeout=10,
                    verify=False,       # self-hosted collab may use self-signed cert
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("KafkaPT v2.5  //  Kafka Pentest Toolkit")
        self.resize(1200, 900); self._build()
        self.status_bar = QStatusBar(); self.setStatusBar(self.status_bar)
        self.status_bar.showMessage(
            "KafkaPT v2.5 ready  —  start in ⚙ CONFIG, then RECON → ATTACK → FINDINGS"
        )
    ...
    def _build(self):
        ...
        self.lbl_sub = QLabel("Kafka Pentest Toolkit  /  v2.5  /  Sprint 0+1+2+3")
